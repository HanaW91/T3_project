# High-dimensional all-categorical imbalance benchmark: n = 100, p = 1000.
...
imbalance_run <- run_imbalance_benchmark(
  ...
  pk_imbalance_fractions = c(0.5),
  active_predictors = 20,
...
write_imbalance_outputs(
  ...
  output_prefix = seed_batch_output_prefix("imbalance_highdim_all_cat", seed_batch),
