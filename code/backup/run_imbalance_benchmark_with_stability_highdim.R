...
utils::write.csv(
  imbalance_results,
  file = file.path("results", "imbalance_stability_highdim_results.csv"),
  row.names = FALSE
)

utils::write.csv(
  imbalance_summary,
  file = file.path("results", "imbalance_stability_highdim_summary.csv"),
  row.names = FALSE
)

utils::write.csv(
  imbalance_predictor_metadata,
  file = file.path("results", "imbalance_stability_highdim_metadata.csv"),
  row.names = FALSE
)
