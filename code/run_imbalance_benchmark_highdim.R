...
# Main check: rare binary categories and how many predictors are affected.
...
utils::write.csv(
  imbalance_results,
  file = file.path("results", "imbalance_highdim_results.csv"),
  row.names = FALSE
)

utils::write.csv(
  imbalance_summary,
  file = file.path("results", "imbalance_highdim_summary.csv"),
  row.names = FALSE
)

utils::write.csv(
  imbalance_predictor_metadata,
  file = file.path("results", "imbalance_highdim_metadata.csv"),
  row.names = FALSE
)
